...
for i in range(len(scores)):
     ...
     #img_file = 'ba.jpeg'
     img_file = 'logo-adrian.png'
     #img_file = 'ba01.png'
     #img_file = 'escudo22.png'
    
     x_start = 30
     y_start = 430
     canvas2.drawImage(img_file, x_start, y_start, width=120, preserveAspectRatio=True, mask='auto')
     ...
     canvas2.drawString(300,650,Fuente_de_informacion_Integracion[:4])
     
     canvas2.drawString(30,630,'Ciencia de datos:')
     canvas2.drawString(300,630,Ciencia_de_datos[:4])
     
     canvas2.drawString(30,610,'Actualidad de Reportes productos:')
     canvas2.drawString(300,610,Actualidad_de_Reportes_productos[:4])
     
     canvas2.drawString(30,590,'Disponibilización:')
     canvas2.drawString(300,590,Disponibilizacion[:4])
     
     canvas2.drawString(30,570,'Protección de datos:')
     canvas2.drawString(300,570,Proteccion_de_datos[:4])
     
     canvas2.drawString(30,550,'Gobernanza de datos:')
     canvas2.drawString(300,550,Gobernanza_de_datos[:4])
    
     canvas2.drawString(30,530,'Gestión de acceso a datos:')
     canvas2.drawString(300,530,Gestion_de_acceso_a_datos[:4])
    
     canvas2.drawString(30,510,'Calidad de los datos:')
     canvas2.drawString(300,510,Calidad_de_los_datos[:4])
    
     canvas2.drawString(30,490,'Reutilización de datos:')
     canvas2.drawString(300,490,Reutilizacion_de_datos[:4])
    
     canvas2.drawString(30,470,'Modelo de datos:')
     canvas2.drawString(300,470,Modelo_de_datos[:4])
     ...
     #-roundRect(x, y, ancho, alto, radio de curva, stroke, fill)
     #stroke y fill, si es 0 inidica no mostrar trazo ni relleno
     canvas2.roundRect(75, 75, 275, 257, 20, stroke = 1, fill = 0)
     canvas2.setFillColorRGB(1, 0.0, 0.0)  # Relleno para el texto "Cuadrado"
     canvas2.drawString(125, 80, "Cuadrado")
