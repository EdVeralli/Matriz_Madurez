...
Score_Final_titulo = 'Area'+";"+"Organismo"+";"+'Dimension 1'+';'+'Dimension 2'+';'+'Dimension 3'+';'+'Dimension 4'+';'+'Dimension 5'+";"+'Dimension 6'+';'+'Dimension 7'+';'+'Dimension 8'+';'+'Dimension 9'+';'+'Dimension 10'
...
for i in df_dim.index: 
     ...
     print("dimension 1:"+str(sum_dim1))
     print("dimension 2:"+str(sum_dim2))
     print("dimension 3:"+str(sum_dim3))
     print("dimension 4:"+str(sum_dim4))
     print("dimension 5:"+str(sum_dim5))
     print("-----final de un reg,istro---------------------")
     p.write(df_dim["area"][i]+";"+df_dim["nombre_preg_codigo"][i]+";"+str(sum_dim1)+";"+str(sum_dim2)+";"+str(sum_dim3)+";"+str(sum_dim4)+";"+str(sum_dim5)+";"+str(sum_dim6)+";"+str(sum_dim7)+";"+str(sum_dim8)+";"+str(sum_dim9)+";"+str(sum_dim10)+"\n")       
