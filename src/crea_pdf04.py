...
for i in range(len(scores)):
     ...
     canvas2.drawString(30,590,'Disponibilizacion:')
     canvas2.drawString(300,590,Disponibilizacion)
     
     canvas2.drawString(30,570,'Proteccion de datos:')
     ...
     if Promedio >= 3 and Promedio< 4:
         ...
         canvas2.drawString(30,390,'La posesion de informacion de calidad es una ventaja para la toma de decisiones')        
     ...
     if Promedio >= 4 and Promedio< 6:
         ...
         canvas2.drawString(30,380,'que se hace, mecanismos de auditoria y de revision de procesos, de compartir los mejores procesos')        
