...
df2.to_csv('respuesta_test.csv', index=False, encoding='utf-8',sep=',')

## TENGO QUE REEMPLAZAR LAS RESPUESTAS CON LETRAS POR NUMEROS
codigos = pd.read_csv('libro_codigos_17_05.csv',sep=';', encoding='utf-8')
...
lista_acciones = []
df3= pd.read_csv("reglas_17_05.csv",sep=';', encoding='utf-8')

with open('reglas_17_05.csv') as csv_file:
    ...
    for row in csv_reader:
        ...
        if  " ^" in pepe  :
                    ...
                    rearmo = "if  ("+token+" in "+header+" ): varpunkt_"+asigna.strip().replace(".","-")
                    pepe5 = rearmo
                    #print("original: ",pepe+"\n")                
                    #print("<<<<<transformada: ",pepe5+"\n")
                    #pepe5 = pepe5[:-1]
